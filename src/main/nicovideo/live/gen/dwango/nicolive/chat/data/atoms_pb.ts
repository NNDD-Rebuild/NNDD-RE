...
export const file_dwango_nicolive_chat_data_atoms: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_duration]);
...
export type Chat = Message<"dwango.nicolive.chat.data.Chat"> & {
   ...
   */
  modifier?: Chat_Modifier | undefined;
...
export type Gift = Message<"dwango.nicolive.chat.data.Gift"> & {
   ...
   */
  advertiserUserId?: bigint | undefined;
   ...
   */
  contributionRank?: number | undefined;

  /**
   * @generated from field: optional dwango.nicolive.chat.data.Gift.GiftBarUpdate gift_bar_update = 8;
   */
  giftBarUpdate?: Gift_GiftBarUpdate | undefined;
};
...
/**
 * @generated from message dwango.nicolive.chat.data.Gift.GiftBarUpdate
 */
export type Gift_GiftBarUpdate = Message<"dwango.nicolive.chat.data.Gift.GiftBarUpdate"> & {
  /**
   * @generated from field: int32 current_level = 1;
   */
  currentLevel: number;

  /**
   * @generated from field: int32 next_level_reward_count = 2;
   */
  nextLevelRewardCount: number;

  /**
   * @generated from field: int32 remaining_points_for_next_level = 3;
   */
  remainingPointsForNextLevel: number;

  /**
   * @generated from field: int32 required_points_for_next_level = 4;
   */
  requiredPointsForNextLevel: number;
};

/**
 * Describes the message dwango.nicolive.chat.data.Gift.GiftBarUpdate.
 * Use `create(Gift_GiftBarUpdateSchema)` to create a new message.
 */
export const Gift_GiftBarUpdateSchema: GenMessage<Gift_GiftBarUpdate> = /*@__PURE__*/
  messageDesc(file_dwango_nicolive_chat_data_atoms, 5, 0);
...
export type Nicoad_V0 = Message<"dwango.nicolive.chat.data.Nicoad.V0"> & {
   ...
   */
  latest?: Nicoad_V0_Latest | undefined;
...
export type CommentLock = Message<"dwango.nicolive.chat.data.CommentLock"> & {
   ...
   */
  followRestriction?: CommentLock_FollowRestriction | undefined;
};
...
export type CommentLock_FollowRestriction = Message<"dwango.nicolive.chat.data.CommentLock.FollowRestriction"> & {
   ...
   */
  minimumFollowDuration?: Duration | undefined;
};
...
export type Marquee = Message<"dwango.nicolive.chat.data.Marquee"> & {
   ...
   */
  display?: Marquee_Display | undefined;
};
